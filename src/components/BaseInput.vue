...
defineProps(['modelValue', 'type', 'label','invalid']);
</script>
...
<template>
  <div>
    <input placeholder=" "
           ...
           v-bind="$attrs"
           class="peer w-full h-full bg-transparent text-blue-gray-700   outline outline-0 focus:outline-0
    ...
    <label
      ...
      peer-disabled:text-transparent peer-disabled:peer-placeholder-shown:text-blue-gray-500 transition-all
      -top-1.5 peer-placeholder-shown:text-sm text-[11px] peer-focus:text-[11px] before:content[' ']
